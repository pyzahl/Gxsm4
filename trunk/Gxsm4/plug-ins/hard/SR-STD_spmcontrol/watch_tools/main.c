...
GtkWidget   *window;
//gchar       *esd_host = NULL; //unused, removed on 31.08.2011 stm
gint 	    curbuf = 0;
gint 	    lag = 2;
gint 	    locount = 0;
gint 	    plevel_l = 0;
...
srdata_idle_func (GtkDatabox * box)
{
   ...
   gtk_widget_queue_draw (GTK_DATABOX (box));
...
/*   gtk_databox_data_add_x_y (GTK_DATABOX (box), POINTS,
   ...
   graph = gtk_databox_lines_new (POINTS, srdataX,  srdataY[0],
                                   &color, 1);
   ...
   /*gtk_databox_data_add_x_y (GTK_DATABOX (box), POINTS,
			     ...
			     GTK_DATABOX_LINES, 0);*/
   graph = gtk_databox_lines_new (POINTS, srdataX,  srdataY[1],
                                   &color, 1);
   gtk_databox_graph_add (GTK_DATABOX (box), graph);
   color.red = 0;
   color.green = 0;
   ...
   /*gtk_databox_data_add_x_y (GTK_DATABOX (box), POINTS,
			     ...
			     GTK_DATABOX_LINES, 0);*/
   graph = gtk_databox_lines_new (POINTS, srdataX,  srdataY[2],
                                   &color, 0.05);
   gtk_databox_graph_add (GTK_DATABOX (box), graph);
