# Example python action script file /home/percy/.gxsm3/pyaction/sf4.py was created.
# - see the Gxsm3 manual for more information
#gxsm.set ("dsp-fbs-bias","4") # set Bias to 0.1V
#gxsm.sleep (10)
#gxsm.set ("dsp-fbs-bias","0.4") # set Bias to 0.1V
