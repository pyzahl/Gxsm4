...
JSON_parameter PACPLL_JSON_parameters[] = {
        ...
        { "HTD_FB_UPPER", &pacpll_parameters.htd_fb_upper, false, "V" },
        { "HTD_FB_LOWER", &pacpll_parameters.htd_fb_lower, false, "V" },
        ...
        { "PULSE_FORM_AB_SELECT", &pacpll_parameters.pulse_form_ab_select, false, "1" },
        ...
        { "PULSE_FORM_DPOS4", &pacpll_parameters.pulse_form_dpt[4], false, "1" },
