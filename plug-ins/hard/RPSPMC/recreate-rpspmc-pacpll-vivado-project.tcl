...
#
# Generated by Vivado on Thu Jan 02 11:56:50 EST 2025
...
set_property -name "webtalk.xsim_launch_sim" -value "821" -objects $obj
...
# module references:
# led_connect, cfg_select, cfg_select, cfg_select, cfg_select, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, axis_dc_filter, axis_decimator, axis_splitter, lms_phase_amplitude_detector, McBSP_io_connect, McBSP_controller, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, axis_bram_push, axis_splitter, axis_4s_combine, axis_FIR, axis_FIR, axis_FIR, axis_FIR, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, gvp, axis_AD5791, axis_splitter, axis_splitter, axis_splitter, axis_splitter, axis_splitter, axis_splitter, axis_splitter, axis_splitter, AD5791_io_connect, axis_splitter, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, axis_splitter, axis_FIR, axis_FIR, axis_py_lockin, axis_splitter, axis_sadd, axis_spm_control, VolumeAdjuster16_14, axis_sc28_to_14, Volume_QControl_Mixer, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, controller_pi, cfg_select, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, amplitude_good, phase_unwrap, controller_pi, cfg_to_axis, cfg_to_axis, PulseForm, cfg_select, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, controller_pi, cfg_select, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_select, cfg_select, cfg_to_axis, cfg_to_axis, controller_pi, cfg_select, axis_ctrlsrc_select, axis_ctrlsrc_select, axis_bram_stream_srcs, cfg_to_axis, axis_selector, cfg_select, cfg_to_axis, cfg_to_axis, QControl
...
proc create_hier_cell_spmc_signal_streaming { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_18
  ...
  # Create instance: cfg_to_axis_selector_16_6, and set properties
  set block_name cfg_to_axis
  set block_cell_name cfg_to_axis_selector_16_6
  if { [catch {set cfg_to_axis_selector_16_6 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $cfg_to_axis_selector_16_6 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins axis_selector_mux_16_6/S_AXIS_13] [get_bd_intf_pins S_AXIS_16]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins axis_selector_mux_16_6/S_AXIS_12] [get_bd_intf_pins S_AXIS_17]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins axis_selector_mux_16_6/S_AXIS_11] [get_bd_intf_pins S_AXIS_18]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins axis_selector_mux_16_6/S_AXIS_10] [get_bd_intf_pins S_AXIS_10]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins axis_selector_mux_16_6/S_AXIS_09] [get_bd_intf_pins S_AXIS_9]
  ...
  # Create port connections
  connect_bd_net -net a_clk [get_bd_pins a_clk] [get_bd_pins axis_dma_stream_srcs/a2_clk] [get_bd_pins cfg_to_axis_selector_16_6/a_clk] [get_bd_pins axis_selector_mux_16_6/a_clk]
  ...
  connect_bd_net -net cfg1_1 [get_bd_pins cfg1] [get_bd_pins cfg_to_axis_selector_16_6/cfg]
  connect_bd_net -net cfg_to_axis_selector_16_6_data [get_bd_pins cfg_to_axis_selector_16_6/data] [get_bd_pins axis_selector_mux_16_6/axis_selector]
  connect_bd_net -net gvp_main_store_data [get_bd_pins push_next] [get_bd_pins axis_dma_stream_srcs/push_next]
  connect_bd_net -net xlconstant_04_dout [get_bd_pins xlconstant_06/dout] [get_bd_pins axis_selector_mux_16_6/S_AXIS_06_tdata]
  connect_bd_net -net xlconstant_5_dout [get_bd_pins xlconstant_5/dout] [get_bd_pins axis_selector_mux_16_6/S_AXIS_05_tdata]
  connect_bd_net -net xlconstant_99_dout [get_bd_pins xlconstant_99/dout] [get_bd_pins axis_selector_mux_16_6/S_AXIS_07_tdata]
  connect_bd_net -net xlconstant_ONE_dout [get_bd_pins xlconstant_ONE/dout] [get_bd_pins axis_selector_mux_16_6/S_AXIS_05_tvalid] [get_bd_pins axis_selector_mux_16_6/S_AXIS_06_tvalid] [get_bd_pins axis_selector_mux_16_6/S_AXIS_07_tvalid]
...
proc create_hier_cell_SPM_control_logic { parentCell nameHier } {
  ...
  # Create instance: axis_splitter_SC, and set properties
  set block_name axis_splitter
  set block_cell_name axis_splitter_SC
  if { [catch {set axis_splitter_SC [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_splitter_SC eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [list \
    CONFIG.MAXIS_TDATA_WIDTH {64} \
    CONFIG.SAXIS_TDATA_WIDTH {64} \
  ] $axis_splitter_SC
  ...
  connect_bd_intf_net -intf_net axis_py_lockin_0_M_AXIS_A2 [get_bd_intf_pins axis_py_lockin_F0/M_AXIS_A2] [get_bd_intf_pins spmc_signal_streaming/S_AXIS_17]
  ...
  connect_bd_intf_net -intf_net axis_py_lockin_0_M_AXIS_X [get_bd_intf_pins axis_py_lockin_F0/M_AXIS_X] [get_bd_intf_pins spmc_signal_streaming/S_AXIS_18]
  ...
  connect_bd_intf_net -intf_net axis_splitter_SC_M_AXIS2 [get_bd_intf_pins axis_py_lockin_F0/S_AXIS_SC] [get_bd_intf_pins axis_splitter_SC/M_AXIS2]
  ...
  connect_bd_intf_net -intf_net axis_splitter_Zslope1_M_AXIS [get_bd_intf_pins axis_splitter_Lck_SRef/M_AXIS] [get_bd_intf_pins spmc_signal_streaming/S_AXIS_16]
  ...
  connect_bd_intf_net -intf_net axis_spm_control_M_AXIS_ZSMON [get_bd_intf_pins axis_spm_control/M_AXIS_ZSMON] [get_bd_intf_pins spmc_signal_streaming/S_AXIS_9]
  ...
  connect_bd_intf_net -intf_net cfg_to_axis_sc_lockin_PhaseInc_M_AXIS [get_bd_intf_pins cfg_to_axis_sc_lockin_PhaseInc/M_AXIS] [get_bd_intf_pins dds_compiler_sc_lockin/S_AXIS_PHASE]
  connect_bd_intf_net -intf_net cfg_to_axis_sc_lockin_PhaseInc_N2_M_AXIS [get_bd_intf_pins axis_py_lockin_F0/S_AXIS_DDS_N2] [get_bd_intf_pins cfg_to_axis_sc_lockin_PhaseInc_DDS_N2/M_AXIS]
  ...
  connect_bd_intf_net -intf_net dds_compiler_sc_lockin_M_AXIS_DATA [get_bd_intf_pins dds_compiler_sc_lockin/M_AXIS_DATA] [get_bd_intf_pins axis_splitter_SC/S_AXIS]
  ...
  connect_bd_net -net a_clk [get_bd_pins a_clk] [get_bd_pins controller_zservo/a_clk] [get_bd_pins cfg3_to_cfg_dac_axis/a_clk] [get_bd_pins cfg3_to_cfg_dac_control/a_clk] [get_bd_pins cfg3_to_gvp_program_vector/a_clk] [get_bd_pins cfg3_to_gvp_setvector/a_clk] [get_bd_pins cfg3_to_rotmxx/a_clk] [get_bd_pins cfg3_to_rotmxy/a_clk] [get_bd_pins cfg3_to_slope_x/a_clk] [get_bd_pins cfg3_to_slope_y/a_clk] [get_bd_pins cfg3_to_x0/a_clk] [get_bd_pins cfg3_to_y0/a_clk] [get_bd_pins cfg3_to_z0/a_clk] [get_bd_pins cfg3_to_bias/a_clk] [get_bd_pins cfg3_to_z_move_step/a_clk] [get_bd_pins cfg3_to_xy_move_step/a_clk] [get_bd_pins gvp_main/a_clk] [get_bd_pins axis_AD5791_0/a_clk] [get_bd_pins axis_splitter_U/a_clk] [get_bd_pins axis_splitter_Z/a_clk] [get_bd_pins axis_splitter_Y/a_clk] [get_bd_pins axis_splitter_X/a_clk] [get_bd_pins axis_splitter_CH0_S16_to_S32_aka_IN1_as32/a_clk] [get_bd_pins axis_splitter_CH1_S16_to_S32_aka_IN2_as_32/a_clk] [get_bd_pins axis_splitter_ZControlSignalPass/a_clk] [get_bd_pins axis_splitter_w_slope/a_clk] [get_bd_pins axis_splitter_Zslope/a_clk] [get_bd_pins spmc_signal_streaming/a_clk] [get_bd_pins dds_compiler_sc_lockin/aclk] [get_bd_pins cfg_to_axis_sc_lockin_PhaseInc/a_clk] [get_bd_pins cfg_to_axis_sc_volume/a_clk] [get_bd_pins cfg_to_axis_sc_target/a_clk] [get_bd_pins cfg_to_axis_lck_tau/a_clk] [get_bd_pins cfg_to_axis_lck_phase/a_clk] [get_bd_pins cfg_to_axis_sc_lockin_PhaseInc_DDS_N2/a_clk] [get_bd_pins axis_splitter_SC/a_clk] [get_bd_pins axis_FIR_CH0/a_clk] [get_bd_pins axis_FIR_CH0/next_dv] [get_bd_pins axis_FIR_CH1/a_clk] [get_bd_pins axis_FIR_CH1/next_dv] [get_bd_pins axis_py_lockin_F0/a_clk] [get_bd_pins axis_splitter_Lck_SRef/a_clk] [get_bd_pins axis_sadd_z_slope/a_clk] [get_bd_pins axis_spm_control/a_clk]
...
preplace port M_AXIS_DMA -pg 1 -lvl 9 -x 4220 -y 650 -defaultsOSRD
preplace port port-id_a_clk -pg 1 -lvl 0 -x -40 -y 1030 -defaultsOSRD
preplace port port-id_gvp_finished -pg 1 -lvl 9 -x 4220 -y 850 -defaultsOSRD
preplace port port-id_gvp_hold -pg 1 -lvl 9 -x 4220 -y 880 -defaultsOSRD
preplace port port-id_dma_data_clk -pg 1 -lvl 9 -x 4220 -y 680 -defaultsOSRD
preplace port port-id_dma_fifo_resetn -pg 1 -lvl 9 -x 4220 -y 710 -defaultsOSRD
preplace portBus cfg3 -pg 1 -lvl 0 -x -40 -y 1110 -defaultsOSRD
preplace portBus exp_p_io -pg 1 -lvl 9 -x 4220 -y 50 -defaultsOSRD
preplace portBus cfg1 -pg 1 -lvl 0 -x -40 -y 1300 -defaultsOSRD
preplace portBus M_AXIS_IN1_pass -pg 1 -lvl 9 -x 4220 -y 390 -defaultsOSRD
preplace portBus enable -pg 1 -lvl 9 -x 4220 -y 1180 -defaultsOSRD
preplace portBus data -pg 1 -lvl 9 -x 4220 -y 2030 -defaultsOSRD
preplace portBus dbg_i -pg 1 -lvl 9 -x 4220 -y 20 -defaultsOSRD
preplace portBus section -pg 1 -lvl 9 -x 4220 -y 80 -defaultsOSRD
preplace portBus dbg_status -pg 1 -lvl 9 -x 4220 -y 910 -defaultsOSRD
preplace portBus M_AXIS_ZSMON_tdata -pg 1 -lvl 9 -x 4220 -y 1890 -defaultsOSRD
preplace portBus M_AXIS_X0MON_tdata -pg 1 -lvl 9 -x 4220 -y 1720 -defaultsOSRD
preplace portBus M_AXIS_XSMON_tdata -pg 1 -lvl 9 -x 4220 -y 1750 -defaultsOSRD
preplace portBus M_AXIS_YSMON_tdata -pg 1 -lvl 9 -x 4220 -y 1810 -defaultsOSRD
preplace portBus M_AXIS_Z0MON_tdata -pg 1 -lvl 9 -x 4220 -y 1850 -defaultsOSRD
preplace portBus mon3 -pg 1 -lvl 9 -x 4220 -y 1690 -defaultsOSRD
preplace portBus mon0 -pg 1 -lvl 9 -x 4220 -y 1510 -defaultsOSRD
preplace portBus mon1 -pg 1 -lvl 9 -x 4220 -y 1540 -defaultsOSRD
preplace portBus mon2 -pg 1 -lvl 9 -x 4220 -y 1580 -defaultsOSRD
preplace portBus last_write_addr -pg 1 -lvl 9 -x 4220 -y 740 -defaultsOSRD
preplace portBus M_AXIS_Z_tdata -pg 1 -lvl 9 -x 4220 -y 940 -defaultsOSRD
preplace portBus exp_n_io -pg 1 -lvl 9 -x 4220 -y 1640 -defaultsOSRD
preplace inst xlslice_cfg_dac_mode -pg 1 -lvl 5 -x 2157 -y 1270 -defaultsOSRD
preplace inst xlslice_cfg_dac_send -pg 1 -lvl 5 -x 2157 -y 1370 -defaultsOSRD
...
preplace inst xlslice_cfg_dac_axis -pg 1 -lvl 5 -x 2157 -y 1110 -defaultsOSRD
preplace inst controller_zservo -pg 1 -lvl 4 -x 1480 -y 1120 -defaultsOSRD
preplace inst cfg3_to_cfg_dac_axis -pg 1 -lvl 5 -x 2157 -y 2240 -defaultsOSRD
preplace inst cfg3_to_cfg_dac_control -pg 1 -lvl 4 -x 1480 -y 1300 -defaultsOSRD
...
preplace inst cfg3_to_rotmxx -pg 1 -lvl 4 -x 1480 -y 1426 -defaultsOSRD
preplace inst cfg3_to_rotmxy -pg 1 -lvl 4 -x 1480 -y 1550 -defaultsOSRD
preplace inst cfg3_to_slope_x -pg 1 -lvl 4 -x 1480 -y 1670 -defaultsOSRD
preplace inst cfg3_to_slope_y -pg 1 -lvl 4 -x 1480 -y 2270 -defaultsOSRD
preplace inst cfg3_to_x0 -pg 1 -lvl 4 -x 1480 -y 1790 -defaultsOSRD
preplace inst cfg3_to_y0 -pg 1 -lvl 4 -x 1480 -y 1910 -defaultsOSRD
preplace inst cfg3_to_z0 -pg 1 -lvl 4 -x 1480 -y 2030 -defaultsOSRD
preplace inst xlslice_gvp_pause -pg 1 -lvl 2 -x 530 -y 630 -defaultsOSRD
preplace inst cfg3_to_bias -pg 1 -lvl 4 -x 1480 -y 2150 -defaultsOSRD
preplace inst cfg3_to_xy_move_step -pg 1 -lvl 4 -x 1480 -y 2400 -defaultsOSRD
preplace inst cfg3_to_z_move_step -pg 1 -lvl 4 -x 1480 -y 2526 -defaultsOSRD
...
preplace inst axis_AD5791_0 -pg 1 -lvl 6 -x 3130 -y 1700 -defaultsOSRD
preplace inst axis_splitter_U -pg 1 -lvl 5 -x 2157 -y 1490 -defaultsOSRD
preplace inst axis_splitter_Z -pg 1 -lvl 6 -x 3130 -y 1250 -defaultsOSRD
preplace inst axis_splitter_Y -pg 1 -lvl 4 -x 1480 -y 820 -defaultsOSRD
preplace inst axis_splitter_X -pg 1 -lvl 4 -x 1480 -y 680 -defaultsOSRD
...
preplace inst axis_splitter_ZControlSignalPass -pg 1 -lvl 5 -x 2157 -y 700 -defaultsOSRD
preplace inst axis_splitter_w_slope -pg 1 -lvl 8 -x 3976 -y 1280 -defaultsOSRD
preplace inst AD5791_io_connect_0 -pg 1 -lvl 8 -x 3976 -y 1650 -defaultsOSRD
preplace inst axis_splitter_Zslope -pg 1 -lvl 6 -x 3130 -y 1110 -defaultsOSRD
preplace inst spmc_signal_streaming -pg 1 -lvl 6 -x 3130 -y -60 -defaultsOSRD
preplace inst dds_compiler_sc_lockin -pg 1 -lvl 2 -x 530 -y 1780 -defaultsOSRD
...
preplace inst axis_splitter_SC -pg 1 -lvl 3 -x 970 -y 1670 -defaultsOSRD
preplace inst axis_FIR_CH0 -pg 1 -lvl 4 -x 1480 -y 70 -defaultsOSRD
preplace inst axis_FIR_CH1 -pg 1 -lvl 3 -x 970 -y 1100 -defaultsOSRD
preplace inst axis_py_lockin_F0 -pg 1 -lvl 6 -x 3130 -y 950 -defaultsOSRD
preplace inst axis_splitter_Lck_SRef -pg 1 -lvl 7 -x 3620 -y 950 -defaultsOSRD
preplace inst axis_sadd_z_slope -pg 1 -lvl 7 -x 3620 -y 1270 -defaultsOSRD
preplace inst axis_spm_control -pg 1 -lvl 5 -x 2157 -y 1790 -defaultsOSRD
preplace netloc Net 1 8 1 N 1640
preplace netloc PS_cfg_data_reg_3 1 0 5 -10 1170 360 1310 NJ 1310 1310 2600 1927J
preplace netloc a_clk 1 0 8 10 1030 370 1050 770 -10 1280 950 1857 840 2870 840 3480 1350 3770
preplace netloc axis_AD5791_0_mon0 1 6 3 3360J 1540 N 1540 4130
preplace netloc axis_AD5791_0_mon1 1 6 3 3370J 1550 N 1550 4170
preplace netloc axis_AD5791_0_mon2 1 6 3 3380J 1620 3780 1570 4130
preplace netloc axis_AD5791_0_mon3 1 6 3 3330J 1740 N 1740 4170
preplace netloc axis_AD5791_0_wire_PMD_clk 1 6 2 N 1630 N
preplace netloc axis_AD5791_0_wire_PMD_dac 1 6 2 N 1670 N
preplace netloc axis_AD5791_0_wire_PMD_sync 1 6 2 N 1650 N
preplace netloc axis_bram_stream_srcs_dma_data_clk 1 6 3 N -80 N -80 4160
preplace netloc axis_dma_stream_srcs_dma_fifo_resetn 1 6 3 N -60 N -60 4150
preplace netloc axis_dma_stream_srcs_last_write_addr 1 6 3 N -40 N -40 4140
preplace netloc axis_dma_stream_srcs_ready 1 2 5 790 940 NJ 940 1700J 790 NJ 790 3330
preplace netloc axis_splitter_ZControlSignalPass_monitor 1 5 4 NJ 720 NJ 720 N 720 4130
preplace netloc axis_splitter_Z_monitor 1 6 3 3340J 1190 3780 940 N
preplace netloc axis_spm_control_0_M_AXIS_X0MON_tdata 1 5 4 2880J 1550 3350J 1560 N 1560 4150
preplace netloc axis_spm_control_0_M_AXIS_XSMON_tdata 1 5 4 2940J 1560 3340J 1750 N 1750 N
preplace netloc axis_spm_control_0_M_AXIS_YSMON_tdata 1 5 4 NJ 1850 NJ 1850 N 1850 4130
preplace netloc axis_spm_control_0_M_AXIS_Z0MON_tdata 1 5 4 NJ 1890 NJ 1890 N 1890 4150
preplace netloc axis_spm_control_0_M_AXIS_ZSMON_tdata 1 5 4 NJ 1930 NJ 1930 N 1930 4170
preplace netloc cfg1_1 1 0 6 40J 890 NJ 890 710J 910 1250J 600 N 600 2560
preplace netloc cfg3_to_bias1_data 1 4 1 1907 1950n
preplace netloc cfg3_to_bias2_data 1 4 1 1917 1970n
preplace netloc cfg3_to_bias_data 1 4 1 1897 1930n
preplace netloc cfg3_to_cfg_dac_axis_data 1 5 4 NJ 2250 NJ 2250 N 2250 4130
preplace netloc cfg3_to_cfg_dac_control_data 1 4 1 1887 1110n
preplace netloc cfg3_to_gvp_program_vector_data 1 2 1 760 760n
preplace netloc cfg3_to_gvp_setvector_data 1 1 1 360 630n
preplace netloc cfg3_to_rotmxx_data 1 4 1 1660 1436n
preplace netloc cfg3_to_rotmxy_data 1 4 1 1650 1560n
preplace netloc cfg3_to_slope_x_data 1 4 1 1640 1680n
preplace netloc cfg3_to_slope_y_data 1 4 1 1877 1850n
preplace netloc cfg3_to_x0_data 1 4 1 1630 1800n
preplace netloc cfg3_to_y0_data 1 4 1 1867 1890n
preplace netloc cfg3_to_z0_data 1 4 1 1887 1910n
preplace netloc cfg_to_axis_lck_tau_data 1 1 1 N 2230
preplace netloc cfg_to_axis_sc_target_data 1 1 4 380 1300 780J 1220 NJ 1220 1710J
preplace netloc cfg_to_axis_sc_volume_data 1 1 4 300 1290 790J 1230 NJ 1230 1690J
preplace netloc controller_zservo_enable 1 4 5 1740J 810 NJ 810 NJ 810 N 810 4160
preplace netloc gvp_0_options 1 3 1 1150 770n
preplace netloc gvp_main_dbg_status 1 3 6 1170J 920 1730J 830 NJ 830 NJ 830 N 830 4140
preplace netloc gvp_main_gvp_finished 1 3 6 1160J 900 1710J 820 NJ 820 NJ 820 N 820 4170
preplace netloc gvp_main_gvp_hold 1 3 6 1260J 910 NJ 910 2580J 850 NJ 850 N 850 4130
preplace netloc gvp_main_store_data 1 3 3 1270 930 1887J 950 2570J
preplace netloc xlslice_cfg_dac_axis_Dout 1 5 1 2460 1110n
preplace netloc xlslice_cfg_dac_mode_Dout 1 5 1 2430 1270n
preplace netloc xlslice_cfg_dac_send_Dout 1 5 1 2400 1370n
preplace netloc xlslice_gvp_reset1_Dout 1 2 1 750J 780n
preplace netloc xlslice_gvp_reset_Dout 1 2 4 740 240 NJ 240 NJ 240 N
preplace netloc xlslice_gvp_setvec_1_Dout 1 2 1 760J 630n
preplace netloc xlslice_gvp_setvec_Dout 1 2 1 760J 730n
preplace netloc S_AXIS_1 1 0 2 NJ 960 NJ
preplace netloc S_AXIS_ch5s_1 1 0 3 NJ 60 NJ 60 NJ
preplace netloc S_AXIS_ch9s_DFREQ_1 1 0 6 -10J -90 NJ -90 NJ -90 NJ -90 NJ -90 2390
preplace netloc S_AXIS_chA_EXEC_1 1 0 6 -20J -70 NJ -70 NJ -70 1170J -80 NJ -80 2400
preplace netloc S_AXIS_chB_PHASE_1 1 0 6 0J -50 NJ -50 NJ -50 1180J -70 NJ -70 2410
preplace netloc S_AXIS_chC_AMPL_1 1 0 6 10J -30 NJ -30 680J -40 1200J -60 NJ -60 2420
preplace netloc S_AXIS_chEs_dFreqCtrl_1 1 0 6 20J -10 NJ -10 690J -30 1210J -50 NJ -50 2430J
preplace netloc axis_FIR_0_M_AXIS 1 4 2 1670 -10 2470
preplace netloc axis_FIR_1_M_AXIS 1 3 1 N 1090
preplace netloc axis_bram_stream_srcs_M_AXIS 1 6 3 N -100 N -100 4170
preplace netloc axis_py_lockin_0_M_AXIS_A2 1 5 2 2940 -450 3370
preplace netloc axis_py_lockin_0_M_AXIS_SDref 1 5 2 2950 310 3310
preplace netloc axis_py_lockin_0_M_AXIS_Sref 1 6 1 3370 940n
preplace netloc axis_py_lockin_0_M_AXIS_X 1 5 2 2940 320 3340
preplace netloc axis_py_lockin_0_M_AXIS_Y 1 5 2 2930 330 3350
preplace netloc axis_sadd_z_slope_M_AXIS_SUM 1 7 1 N 1270
preplace netloc axis_splitter_CH0_S16_to_S32_M_AXIS 1 3 1 N 50
preplace netloc axis_splitter_CH0_S16_to_S33_M_AXIS 1 2 1 710 950n
preplace netloc axis_splitter_CH1_S16_to_S32_aka_IN2_as_32_M_AXIS2 1 2 4 700J -20 1230J -40 NJ -40 2440J
preplace netloc axis_splitter_SC_M_AXIS2 1 3 3 1320 960 NJ 960 2550J
preplace netloc axis_splitter_U_M_AXIS 1 5 1 2530 -180n
preplace netloc axis_splitter_U_M_AXIS2 1 5 1 2410 1490n
preplace netloc axis_splitter_X_M_AXIS 1 4 2 1660J -30 2450
preplace netloc axis_splitter_X_M_AXIS2 1 4 1 1877 680n
preplace netloc axis_splitter_Y_M_AXIS 1 4 2 1680J -20 2460
preplace netloc axis_splitter_Y_M_AXIS2 1 4 1 1630 820n
preplace netloc axis_splitter_Z1_M_AXIS 1 5 2 2950 -440 3360
preplace netloc axis_splitter_Z1_M_AXIS2 1 6 1 3360 1110n
preplace netloc axis_splitter_ZControlSignalPass_M_AXIS 1 5 1 2500 -140n
preplace netloc axis_splitter_ZControlSignalPass_M_AXIS2 1 5 1 2560J 700n
preplace netloc axis_splitter_Z_M_AXIS 1 5 2 2920 340 3320
preplace netloc axis_splitter_Z_M_AXIS2 1 6 1 N 1250
preplace netloc axis_splitter_Zslope1_M_AXIS 1 5 3 2910 780 NJ 780 3770
preplace netloc axis_splitter_Zslope1_M_AXIS2 1 4 4 1917 800 NJ 800 NJ 800 3760
preplace netloc axis_splitter_w_slope_M_AXIS 1 5 4 2900 1360 N 1360 N 1360 4160
preplace netloc axis_splitter_w_slope_M_AXIS2 1 5 4 2950 1370 N 1370 N 1370 4130
preplace netloc axis_spm_control_0_M_AXIS1 1 5 1 2610 1620n
preplace netloc axis_spm_control_0_M_AXIS2 1 5 1 2930 1640n
preplace netloc axis_spm_control_M_AXIS3 1 5 1 2600 1240n
preplace netloc axis_spm_control_M_AXIS4 1 4 2 1927 1210 2390
preplace netloc axis_spm_control_M_AXIS_ZSMON 1 5 1 2590 180n
preplace netloc axis_spm_control_M_AXIS_Z_SLOPE 1 5 1 2890 1100n
preplace netloc cfg3_to_cfg_dac_axis_M_AXIS 1 5 1 2950 1700n
preplace netloc cfg_to_axis_sc_lockin_PhaseInc_M_AXIS 1 1 1 N 1770
preplace netloc cfg_to_axis_sc_lockin_PhaseInc_N2_M_AXIS 1 1 5 310J 1570 NJ 1570 1330J 1000 1750J 940 2540
preplace netloc controller_zservo_M_AXIS_CONTROL 1 4 1 1730 1070n
preplace netloc controller_zservo_M_AXIS_MON 1 4 1 1720 690n
preplace netloc controller_zservo_M_AXIS_PASS 1 4 2 1690J 0 2480
preplace netloc dds_compiler_sc_lockin_M_AXIS_DATA 1 2 1 790 1660n
preplace netloc gvp_main_M_AXIS_SRCS 1 3 3 1320J -10 1630J 30 2520
preplace netloc gvp_main_M_AXIS_U 1 3 2 1300 1010 1770J
preplace netloc gvp_main_M_AXIS_X 1 3 1 N 670
preplace netloc gvp_main_M_AXIS_Y 1 3 1 1170 690n
preplace netloc gvp_main_M_AXIS_Z 1 3 2 1290 990 1760J
preplace netloc gvp_main_M_AXIS_gvp_time 1 3 3 1310J -30 1650J 10 2490
preplace netloc gvp_main_M_AXIS_index 1 3 3 1330J -20 1640J 20 2510
levelinfo -pg 1 -40 170 530 970 1480 2157 3130 3620 3976 4220
pagesize -pg 1 -db -bbox -sgen -300 -460 7360 4020
"
}
...
",
   ...
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 2520 -y 590 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 2520 -y 620 -defaultsOSRD
preplace port Vaux0 -pg 1 -lvl 0 -x 0 -y 20 -defaultsOSRD
preplace port Vaux1 -pg 1 -lvl 0 -x 0 -y 50 -defaultsOSRD
preplace port Vaux8 -pg 1 -lvl 0 -x 0 -y 80 -defaultsOSRD
preplace port Vaux9 -pg 1 -lvl 0 -x 0 -y 110 -defaultsOSRD
preplace port Vp_Vn -pg 1 -lvl 0 -x 0 -y 140 -defaultsOSRD
preplace port gpio_rtl_0 -pg 1 -lvl 6 -x 2520 -y 50 -defaultsOSRD
preplace port spi_rtl_0 -pg 1 -lvl 6 -x 2520 -y 200 -defaultsOSRD
preplace port gpio_rtl_1 -pg 1 -lvl 6 -x 2520 -y 80 -defaultsOSRD
preplace port gpio_rtl_2 -pg 1 -lvl 6 -x 2520 -y 110 -defaultsOSRD
...
preplace port port-id_adc_csn_o -pg 1 -lvl 6 -x 2520 -y 1330 -defaultsOSRD
preplace port port-id_adc_enc_n_o -pg 1 -lvl 6 -x 2520 -y 140 -defaultsOSRD
preplace port port-id_adc_enc_p_o -pg 1 -lvl 6 -x 2520 -y 170 -defaultsOSRD
preplace port port-id_dac_clk_o -pg 1 -lvl 6 -x 2520 -y 1170 -defaultsOSRD
preplace port port-id_dac_rst_o -pg 1 -lvl 6 -x 2520 -y 1200 -defaultsOSRD
preplace port port-id_dac_sel_o -pg 1 -lvl 6 -x 2520 -y 1230 -defaultsOSRD
preplace port port-id_dac_wrt_o -pg 1 -lvl 6 -x 2520 -y 1260 -defaultsOSRD
...
preplace portBus dac_dat_o -pg 1 -lvl 6 -x 2520 -y 1290 -defaultsOSRD
preplace portBus dac_pwm_o -pg 1 -lvl 6 -x 2520 -y 20 -defaultsOSRD
preplace portBus daisy_n_i -pg 1 -lvl 0 -x 0 -y 830 -defaultsOSRD
preplace portBus daisy_n_o -pg 1 -lvl 6 -x 2520 -y 1060 -defaultsOSRD
preplace portBus daisy_p_i -pg 1 -lvl 0 -x 0 -y 800 -defaultsOSRD
preplace portBus daisy_p_o -pg 1 -lvl 6 -x 2520 -y 1030 -defaultsOSRD
preplace portBus exp_n_io -pg 1 -lvl 6 -x 2520 -y 920 -defaultsOSRD
preplace portBus exp_p_io -pg 1 -lvl 6 -x 2520 -y 330 -defaultsOSRD
preplace portBus led_o -pg 1 -lvl 6 -x 2520 -y 1460 -defaultsOSRD
preplace inst PAC_PLL -pg 1 -lvl 2 -x 480 -y 1200 -defaultsOSRD
preplace inst PS -pg 1 -lvl 5 -x 2290 -y 630 -defaultsOSRD
preplace inst PS_data_transport -pg 1 -lvl 3 -x 1040 -y 1000 -defaultsOSRD
preplace inst SPM_control_logic -pg 1 -lvl 4 -x 1630 -y 620 -defaultsOSRD
preplace inst axis_red_pitaya_adc_0 -pg 1 -lvl 1 -x 140 -y 1190 -defaultsOSRD
preplace inst axis_red_pitaya_dac_0 -pg 1 -lvl 5 -x 2290 -y 1230 -defaultsOSRD
preplace inst led_connect_0 -pg 1 -lvl 5 -x 2290 -y 1460 -defaultsOSRD
preplace inst util_ds_buf_1 -pg 1 -lvl 4 -x 1630 -y 1030 -defaultsOSRD
preplace inst util_ds_buf_2 -pg 1 -lvl 5 -x 2290 -y 1030 -defaultsOSRD
preplace inst xlconcat_spmc_status -pg 1 -lvl 4 -x 1630 -y 140 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 3 -x 1040 -y 220 -defaultsOSRD
preplace inst Q_Control_Stage -pg 1 -lvl 4 -x 1630 -y 1230 -defaultsOSRD
preplace netloc Net 1 4 2 2020J 920 NJ
preplace netloc Net1 1 4 2 1870J 330 NJ
preplace netloc PS_Amplitude_Controller_status_max 1 2 3 NJ 1420 NJ 1420 1840
preplace netloc PS_Amplitude_Controller_status_min 1 2 3 NJ 1460 NJ 1460 2110
preplace netloc PS_Dout 1 1 5 290 830 840 770 1430 940 NJ 940 2490
preplace netloc PS_Phase_Controller_mon_control_B 1 2 1 N 1320
preplace netloc PS_Phase_Controller_status_max 1 2 3 NJ 1440 NJ 1440 1830
preplace netloc PS_Phase_Controller_status_min 1 2 3 NJ 1480 NJ 1480 2110
preplace netloc PS_cfg_data 1 1 5 300 1550 840 1260 1290 910 2000J 930 2500
preplace netloc PS_cfg_data_reg_2 1 2 4 860 790 1400J 950 NJ 950 2470
preplace netloc PS_cfg_data_reg_3 1 3 3 1430 320 NJ 320 2480
preplace netloc PS_data_transport_enable 1 3 2 1270 1510 NJ
preplace netloc PS_data_transport_finished_state 1 3 2 1280 1530 NJ
preplace netloc PS_data_transport_mon_control 1 3 2 1340 900 2060J
preplace netloc PS_data_transport_writeposition 1 3 2 1370 930 1890J
preplace netloc SPM_control_logic_M_AXIS_PASS_tdata 1 4 1 1960 430n
preplace netloc SPM_control_logic_M_AXIS_XSMON_tdata 1 4 1 1880 410n
preplace netloc SPM_control_logic_M_AXIS_ZSMON_tdata 1 4 1 2090 590n
preplace netloc SPM_control_logic_dbg_status 1 2 3 860 330 NJ 330 1830
preplace netloc SPM_control_logic_dma_fifo_resetn 1 4 1 1900 830n
preplace netloc SPM_control_logic_enable 1 3 2 1430 280 1860
preplace netloc SPM_control_logic_gvp_finished 1 3 2 1410 290 1850
preplace netloc SPM_control_logic_gvp_hold 1 3 2 1290 300 1840
preplace netloc SPM_control_logic_last_write_addr 1 4 1 2070 770n
...
preplace netloc amplitude_controller_mon_signal 1 2 3 710 780 1420J 920 1980J
preplace netloc axis_dc_filter_0_dbg_m 1 2 3 770J 1330 1390J 1340 1990
preplace netloc axis_dc_filter_0_dbg_mdc 1 2 3 760J 1340 1320J 1350 2010
preplace netloc axis_red_pitaya_adc_0_adc_clk1 1 1 4 270 820 820 1250 1410 1120 1840
preplace netloc axis_red_pitaya_adc_0_adc_csn 1 1 5 280J 840 790J 1320 1430J 1330 NJ 1330 NJ
preplace netloc axis_red_pitaya_dac_0_dac_clk 1 5 1 2500J 1170n
preplace netloc axis_red_pitaya_dac_0_dac_dat 1 5 1 2470J 1270n
preplace netloc axis_red_pitaya_dac_0_dac_rst 1 5 1 2470J 1200n
preplace netloc axis_red_pitaya_dac_0_dac_sel 1 5 1 NJ 1230
preplace netloc axis_red_pitaya_dac_0_dac_wrt 1 5 1 2500J 1250n
preplace netloc cfg_axis_phaseinc_status 1 2 3 750J 1350 1290J 1360 1860
preplace netloc cfg_axis_volume_status 1 2 3 740J 1360 1260J 1370 2000
preplace netloc clk_wiz_0_clk_out1 1 4 1 1830 1230n
preplace netloc clk_wiz_0_locked 1 4 1 1840 1250n
preplace netloc daisy_n_i_1 1 0 4 NJ 830 260J 810 NJ 810 1380J
preplace netloc daisy_p_i_1 1 0 4 NJ 800 NJ 800 NJ 800 1390J
preplace netloc gpio2_io_9_x20_1 1 4 1 1920 670n
preplace netloc gpio2_io_i_1 1 2 3 NJ 1400 1220J 1410 2100
preplace netloc gpio2_io_i_2 1 4 1 1910 790n
preplace netloc gpio_io_0_x2_1 1 4 1 1970 430n
preplace netloc gpio_io_3_x7_1 1 2 3 730J 1370 1250J 1380 2030
preplace netloc gpio_io_3_x8_1 1 2 3 720J 1380 1240J 1390 1950
preplace netloc gpio_io_4_x9_1 1 2 3 660J 1390 1230J 1400 2080
preplace netloc gpio_io_5_x11_1 1 3 2 1350 1110 2040J
preplace netloc gpio_io_7_x15_1 1 4 1 2000 650n
preplace netloc gpio_io_7_x16_1 1 4 1 1930 670n
preplace netloc gpio_io_8_x17_1 1 4 1 2020 690n
preplace netloc gpio_io_8_x18_1 1 4 1 1940 710n
preplace netloc led_connect_0_leds 1 5 1 NJ 1460
preplace netloc lms_phase_amplitude_detector_0_zero_spcp 1 2 1 850 1130n
preplace netloc s_axis_aclk_1 1 4 1 2050 810n
preplace netloc util_ds_buf_1_IBUF_OUT 1 4 1 N 1030
preplace netloc util_ds_buf_2_OBUF_DS_N 1 5 1 2470J 1050n
preplace netloc util_ds_buf_2_OBUF_DS_P 1 5 1 NJ 1030
preplace netloc xlconcat_spmc_status_dout 1 4 1 2030 140n
preplace netloc xlslice_0_Dout 1 3 1 NJ 220
preplace netloc PS_Amplitude_Controller_M_AXIS_CONTROL 1 2 2 800 1180 NJ
preplace netloc PS_Amplitude_Controller_M_AXIS_CONTROL2 1 2 1 670 910n
preplace netloc PS_Amplitude_Controller_M_AXIS_PASS2 1 2 1 780 970n
preplace netloc PS_BRAM_PORTA 1 2 4 850 310 NJ 310 NJ 310 2470
preplace netloc PS_Phase_Controller_M_AXIS_CONTROL2 1 2 1 690 930n
preplace netloc PS_Phase_Controller_M_AXIS_PASS2 1 2 1 770 950n
preplace netloc PS_data_transport_M_AXIS3 1 3 1 1300 570n
preplace netloc PS_data_transport_M_AXIS5 1 3 1 1320 610n
preplace netloc PS_data_transport_M_AXIS6 1 3 1 1330 630n
preplace netloc PS_data_transport_M_AXIS_ADC2 1 2 2 660 530 NJ
preplace netloc PS_data_transport_M_AXIS_aux 1 3 1 1360 880n
preplace netloc SPM_control_logic_M_AXIS 1 4 1 N 390
preplace netloc S_AXIS1_1 1 2 1 700 890n
preplace netloc S_AXIS_ch5s_1 1 2 2 680 650 NJ
preplace netloc S_AXIS_ch9s_1 1 3 1 1290 550n
preplace netloc S_AXIS_chBs_1 1 3 1 1310 590n
preplace netloc Volume_QControl_Mixer_0_M_AXIS 1 4 1 2110 1200n
preplace netloc axis_dc_filter_0_M_AXIS_AC16 1 2 2 810 1240 NJ
preplace netloc axis_dc_filter_0_M_AXIS_ACDC 1 2 1 830 920n
preplace netloc axis_red_pitaya_adc_0_M_AXIS 1 1 1 N 1170
preplace netloc lms_phase_amplitude_detector_0_M_AXIS_SC 1 2 2 780 1200 NJ
preplace netloc processing_system7_0_DDR 1 5 1 NJ 590
preplace netloc processing_system7_0_FIXED_IO 1 5 1 2500J 610n
levelinfo -pg 1 0 140 480 1040 1630 2290 2520
pagesize -pg 1 -db -bbox -sgen -170 0 2680 1590
"
}
