...
// bititan: scp Makefile *.cpp *.h  root@130.199.243.110:/opt/redpitaya/www/apps/rpspmc/src

// On rev RP OS 2.x >>> need to install: root@rp-f09296:/opt/redpitaya/www/apps/rpspmc#
// if not working via apt, download libwebsocketpp-dev_0.8.2-4_armhf.deb and run dpkg -i libwebsocketpp-dev_0.8.2-4_armhf.deb

// put virt_to_phy.cpp into git

// root@rp-f0cd7c:/opt/redpitaya/www/apps/rpspmc# apt-get install libwebsocketpp-dev
// root@rp-f0cd7c:/opt/redpitaya/www/apps/rpspmc# tail -f /var/log/redpitaya_debug.log 

#if 0
alling application: start
...
percy@bititan:~$ ssh root@130.199.243.110
Enter passphrase for key '/home/percy/.ssh/id_dsa': 
root@130.199.243.110's password: 
...
# Pro Applications: ""
##############################################################################
Last login: Tue Jan 28 21:02:46 2025
root@rp-f0cd7c:~# date
Tue Jan 28 09:03:20 PM UTC 2025
root@rp-f0cd7c:~# rw
root@rp-f0cd7c:~# cd /opt/redpitaya/www/apps/rpspmc/
root@rp-f0cd7c:/opt/redpitaya/www/apps/rpspmc# tail -f /var/log/redpitaya_debug.log 
Calling application: start
Loading specific FPGA from: '/opt/redpitaya/www/apps/rpspmc/fpga.bit'
Loading application: '/opt/redpitaya/www/apps/rpspmc/controllerhf.so'
Loading RPSPMC PACPLL application
*** INIT RP FPGA RPSPMC PACPLL ***
INIT RP FPGA RPSPMC PACPLL: BRAM, CONTROL and GPIO MEMORY MAPPINGs completed.
INIT RP FPGA RPSPMC PACPLL. --- FPGA MEMORY MAPPING ---
RP FPGA RPSPMC PACPLL PAGESIZE:        0x00001000
RP FPGA RPSPMC PACPLL BRAM PLL  mapped 0x40000000 - 0x407fffff   block length: 0x00800000
RP FPGA RPSPMC PACPLL CFG REG   mapped 0x43000000 - 0x43000fff   block length: 0x00001000
RP FPGA RPSPMC PACPLL GPIO REGs mapped 0x42002000 - 0x4200dfff   block length: 0x0000c000
##Configure GVP: Reset RO[-1]
INIT RP FPGA RPSPMC PACPLL: initializing DMA support.
SPMC DMA: spmc_dma_support class init
RP FPGA RPSPMC AXI_DMA          mapped 0x40400000 - 0x40400fff   block length: 0x00001000  => *0xb6f07000
RP FPGA RPSPMC DMA S2MM_DESC    mapped 0x01000000 - 0x01000fff   block length: 0x00001000  => *0xb6f06000
RP FPGA RPSPMC DMA DEST MEM     mapped 0x01001000 - 0x01100fff   block length: 0x00100000  PHYS ADDR[pid=253, ret=0]: Paddr: 0x00000000x for Vaddr: 0xb2390000  ##[0x01001000]
XIL XDMAPS MEM     mapped 0xf8004000 - 0xf8005000   block length: 0x00001000  PHYS ADDR[pid=253, ret=0]: Paddr: 0x00000000x for Vaddr: 0xb6f05000  ##[0xf8004000]
SPMC DMA: spmc_dma_support class init -- mmaps completed.
SPMC DMA: spmc_dma_support class init -- clear mem completed.
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: spmc_dma_support class init -- Reset DMA completed.
INIT RP FPGA RPSPMC PACPLL: initializing worker threads.
INIT RP FPGA RPSPMC PACPLL completed.
Red Pitaya RPSPMC PACPLL API init memory mappings success!
Starting thread: SPMC stream_server test
RP PACPLL DC-Offset =   0.000000  {300000}
##rp_spmc_AD5791_init
** adjusting rotation to 0
## Send axis data to AD5781 axis 0 to 00200020
## Send axis data to AD5781 axis 1 to 00200020
## Send axis data to AD5781 axis 2 to 00200020
## Send axis data to AD5781 axis 3 to 00200020
## Send axis data to AD5781 axis 4 to 00200020
## Send axis data to AD5781 axis 5 to 00200020
##ad5791setdac: 0 V in Q19 int = 00000000 0b
##  Set axis data to AD5781 axis 0 to 00100000
##ad5791setdac: 0 V in Q19 int = 00000000 0b
##  Set axis data to AD5781 axis 1 to 00100000
##ad5791setdac: 0 V in Q19 int = 00000000 0b
##  Set axis data to AD5781 axis 2 to 00100000
## Send axis data to AD5781 axis 3 to 00100000
##**** GVP INIT
##Configure GVP: Reset RO[0]
Init Vector[PC=000] to zero, decii=2
Init Vector[PC=001] to zero, decii=2
Init Vector[PC=002] to zero, decii=2
Init Vector[PC=003] to zero, decii=2
Init Vector[PC=004] to zero, decii=2
Init Vector[PC=005] to zero, decii=2
Init Vector[PC=006] to zero, decii=2
Init Vector[PC=007] to zero, decii=2
Init Vector[PC=008] to zero, decii=2
Init Vector[PC=009] to zero, decii=2
Init Vector[PC=010] to zero, decii=2
Init Vector[PC=011] to zero, decii=2
Init Vector[PC=012] to zero, decii=2
Init Vector[PC=013] to zero, decii=2
Init Vector[PC=014] to zero, decii=2
Init Vector[PC=015] to zero, decii=2
Init Vector[PC=016] to zero, decii=2
Init Vector[PC=017] to zero, decii=2
Init Vector[PC=018] to zero, decii=2
Init Vector[PC=019] to zero, decii=2
Init Vector[PC=020] to zero, decii=2
Init Vector[PC=021] to zero, decii=2
Init Vector[PC=022] to zero, decii=2
Init Vector[PC=023] to zero, decii=2
Init Vector[PC=024] to zero, decii=2
Init Vector[PC=025] to zero, decii=2
Init Vector[PC=026] to zero, decii=2
Init Vector[PC=027] to zero, decii=2
Init Vector[PC=028] to zero, decii=2
Init Vector[PC=029] to zero, decii=2
Init Vector[PC=030] to zero, decii=2
Init Vector[PC=031] to zero, decii=2
Red Pitaya RPSPMC PACPLL API init completed!
Application loaded succesfully!
Starting WS-server
stop_ws_server()
start_ws_server()
...
Running...[DONE]
RP PACPLL DC-Offset =   0.000000  {300000}
OnNewParams: OP=1 Auto Offset Run, DC=0.000000 mV
##Configure PAC TAU: 40 us, 1.5 us, M=0
##Configure PAC TAU: 40 us, 40 us, M=0
##Configure PH-Controller: setpt=0, cp=0 ci=0, upper=32768 lower=0.1, amth=0.005, frq=32765, en=0
##Configure AM-Controller: setpt=0.02, cp=0 ci=0, upper=0.5 lower=0 volume=0.2 V, en=0
##Configure AM-Controller: setpt=0.1, cp=0 ci=0, upper=0.5 lower=0 volume=0.2 V, en=0
##Configure AM-Controller: setpt=0.1, cp=0 ci=0, upper=0.3 lower=0 volume=0.2 V, en=0
##Configure AM-Controller: setpt=0.1, cp=0 ci=0, upper=0.3 lower=-0.3 volume=0.2 V, en=0
##Configure AM-Controller: setpt=0.1, cp=0.0562341 ci=0, upper=0.3 lower=-0.3 volume=0.2 V, en=0
##Configure AM-Controller: setpt=0.1, cp=0.0562341 ci=0.01, upper=0.3 lower=-0.3 volume=0.2 V, en=0
##Configure PH-Controller: setpt=0.872665, cp=0 ci=0, upper=32768 lower=0.1, amth=0.005, frq=32765, en=0
##Configure PH-Controller: setpt=0.872665, cp=0 ci=0, upper=33000 lower=0.1, amth=0.005, frq=32765, en=0
##Configure PH-Controller: setpt=0.872665, cp=0 ci=0, upper=33000 lower=30000, amth=0.005, frq=32765, en=0
##Configure PH-Controller: setpt=0.872665, cp=0 ci=0, upper=33000 lower=30000, amth=0.005, frq=32765, en=0
##Configure PH-Controller: setpt=0.872665, cp=0.000158489 ci=0, upper=33000 lower=30000, amth=0.005, frq=32765, en=0
##Configure PH-Controller: setpt=0.872665, cp=0.000158489 ci=7.07946e-08, upper=33000 lower=30000, amth=0.005, frq=32765, en=0
##Configure GVP: Reset RO[0]
##Configure SPMC Bias=0.332103 V...[0] Verify: Bias=0 V Bbuf: 142637290 regA: 0 ERROR=-142637290 regB: 0
##Configure SPMC Bias=0.332103 V...[1] Verify: Bias=0 V Bbuf: 142637290 regA: 0 ERROR=-142637290 regB: 0
** set dZxy slopes 0, 0 ** dZ-step: 2 => 10
** set dZxy slopes 0, 0 ** dZ-step: 2 => 10
** set dZxy slopes 0, 0 ** dZ-step: 2 => 10
** set dZxy slopes 0, 0 ** dZ-step: 2 => 10
Z Servo Mode = 0
##Configure RP SPMC Z-Servo Controller: set= 0.001  cp=0 ci=0 upper=0 lower=0
##Configure RP SPMC Z-Servo Controller: mode= 0  Zset=0 offset_comp=0
Z Servo Mode = 0
##Configure RP SPMC Z-Servo Controller: set= 0.001  cp=0.0220508 ci=0.0178896 upper=0 lower=0
##Configure RP SPMC Z-Servo Controller: mode= 0  Zset=0 offset_comp=0

** WRITE GVP: PC=0: stream_debug_flags = opts = 0x0000
** Auto calc init vector to absolute position [0 0 0 0] V
** XYZU readings are => [0 0 0 0] V, bias buffer=0.332103 V
>>>>>>>>>>>>[PC=000] AUTO INIT **{dXYZU => [0 0 0 0.332103] V}
    ** Auto calc decii: slew=200 pts/s, dmin=0.332103 V, dt=0.005 s, ##=625000, Nsteps=400 {ddmin=0.00332103 uV #1.42637e+06 ddmax=0.00332103 uV #1.42637e+06}

Write Vector[PC=000] = [[0100], {0004}, Op00000000, #0000, 0000, dX        0 uV, dY        0 uV, dZ        0 uV, dU 830.2583014 uV, dA        0 uV, dB        0 uV, 0,0,0, decii=156250]

Write Vector[PC=001] = [[0000], {0000}, Op00000000, #0000, 0000, dX        0 uV, dY        0 uV, dZ        0 uV, dU        0 uV, dA        0 uV, dB        0 uV, 0,0,0, decii=128]
##Configure GVP: Reset RO[-1]
...
SPMC DMA: (RE)STARTING DMA: RESET DMA ** HALT ** INIT0xDD ** SETUP-DMA
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: S2MM Base Descriptor Address 0x01000000
SPMC DMA: ****************************** BD
SPMC DMA: BD_0 @0x01000000:
SPMC DMA: - NEXT_DESC 0x01000040
SPMC DMA: - BUFF_ADDR 0x01001000
SPMC DMA: - CONTROL   0x00080000
SPMC DMA: BD_1 @0x01000040:
SPMC DMA: - NEXT_DESC 0x01000080
SPMC DMA: - BUFF_ADDR 0x01081000
SPMC DMA: - CONTROL   0x00080000
SPMC DMA: CYCLIC TAIL BD_2 @0x01000080:
SPMC DMA: - NEXT_DESC 0x01000000
SPMC DMA: - BUFF_ADDR 0x01101000
SPMC DMA: - CONTROL   0x00000004
SPMC DMA: ******************************
SPMC DMA: S2MM Tail Descriptor Address 0x01000080
SPMC DMA: SET CURRENT DESCRIPTOR ADDRESS
SPMC DMA: Descriptor 0 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: Descriptor 1 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: Descriptor 0 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: Descriptor 1 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: SET START DMA IN CONTROL RS=1 + CYCLIC
SPMC DMA: Descriptor 0 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: Descriptor 1 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: SET START DMA IN CONTROL RS=1 + CYCLIC + ~IRqEn -- ** no IRQ
SPMC DMA: Descriptor 0 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: Descriptor 1 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: SET TAIL DESCRIPTOR ADDRESS (CYCLIC: any value not part of BD chain!)
SPMC DMA: Descriptor 0 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: Descriptor 1 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
SPMC DMA: DMA ACTIVE
...
SPMC DMA: Descriptor 1 Status: 0x00000000 DA:  0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000 0x000000
SPMC DMA: S2MM status 0x00000000 @0x40400034 [Running           ]
##Configure GVP: Run RO[-1]
*** GVP Control Mode EXEC: START 3 (taking out of RESET)
##Configure SPMC Bias=0.332103 V...[0] Verify: Bias=0 V Bbuf: 142637152 regA: 0 ERROR=-142637152 regB: 0
##Configure SPMC Bias=0.332103 V...[1] Verify: Bias=0 V Bbuf: 142637152 regA: 0 ERROR=-142637152 regB: 0
