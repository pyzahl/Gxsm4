...
void ViewControl::RemoveIndicators(){
	g_slist_foreach((GSList*) gindicatorlist, (GFunc) ViewControl::delete_object, this);
...
void ViewControl::RemoveObjects(){
	g_slist_foreach((GSList*) gobjlist, (GFunc) ViewControl::delete_object, this);
...
void ViewControl::view_tool_remove_active_callback (GSimpleAction *simple, GVariant *parameter, 
        ...
        if (vc->current_vobject){
                ...
                vc->delete_object (vc->current_vobject, vc);
