 ...
 * ========================================
 * 2D Graubild, Darstellungsmode "Quick"/"Direct" �ber mem2d-Mapping
 * class Grey2D    : public View{};
 *
 * Linien-Profil-Dartsellung aus 2D Z Daten
 * class Line      : public View{};
 *
 * Schnelle Profil-Dartsellung aus 2D Z Daten, H�henprofilen untereinander
 * class Profiles  : public View{};
 *
 * Echte-3D-Dartsellung ... + povray Unterst�tzung, etc....
